SELECT APCE.[APCE_Ident]
      ...
      ,APCE.[Episode_Number]
      ,APCE.[Ethnic_Group]
	  ,APCE.[Der_Age_At_CDS_Activity_Date] as [Age]
	  ...
	  ,APCE.[Der_Diagnosis_All]
	  ,APCE.[Der_Procedure_All]
...
WHERE APCE.[Der_Provider_Code] = 'REM'
AND APCE.[Discharge_Date] BETWEEN '2023-04-01' AND '2023-04-30'
AND APCE.[Patient_Classification] IN (1,2)
